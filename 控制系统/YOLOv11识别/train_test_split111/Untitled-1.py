...
val_ratio = 0.1   # 验证集比例
imgpath = r'C:\Users\yangy\Desktop\paper\biyesheji\yolov11\data\JPEGImages'  # 图片路径
txtpath = r'C:\Users\yangy\Desktop\paper\biyesheji\yolov11\data\Annotations'      # 标签路径

BASE_DIR = Path(r'C:\Users\yangy\Desktop\paper\biyesheji\yolov11\train_test_split111')  # 输出目录
...
print("数据集已保存到:", train_test_split)